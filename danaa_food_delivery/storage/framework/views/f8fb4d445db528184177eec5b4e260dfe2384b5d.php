	...
	<table height="100%" width="100%">
	  ...
	  <tbody>
		...
		<tr style="border-bottom:1px solid #ccc">                      
		  ...
		  <td style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;"><?php echo e(getcong('currency_symbol')); ?><?php echo e(\App\Menu::getMenunfo($order->item_id)->price); ?></td>
		  <td style="width:38%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">	<?php echo e(getcong('currency_symbol')); ?><?php echo e($order->item_price); ?>
