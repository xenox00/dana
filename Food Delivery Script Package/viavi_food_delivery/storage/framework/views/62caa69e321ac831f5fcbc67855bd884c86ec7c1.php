...
<?php $__env->startSection("content"); ?>
 ...
 <div class="sub-banner" style="background:url(<?php echo e(URL::asset('upload/'.getcong('page_bg_image'))); ?>) no-repeat center top;">
    ...
    <div class="col-md-10 col-sm-9">  
      ...
      <div class="sub_cont_rt"><?php echo e(getcong_type($restaurant->restaurant_type)); ?></div>
...
<div class="restaurant_list_detail">
    <div class="container">
      ...
      <?php echo $__env->make('_particles.pagination', ['paginator' => $reviews], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
