  ...
  <header class="sticky">
    <div class="container">
      ...
      <ul class="animenu_nav">
            <li> <a href="<?php echo e(URL::to('/')); ?>">Acceuil</a></li>
            ...
            <?php if(Auth::check() and Auth::user()->usertype=='User'): ?>
             ...
             <li> <a href="javascript:void(0);">Mon compte<i class="icon-down-open-mini"></i></a>
              <ul class="animenu_nav_child">
                <li><a href="<?php echo e(URL::to('profile')); ?>">Editez Profile</a></li>
                <li><a href="<?php echo e(URL::to('change_pass')); ?>">Changez Password</a></li>
                <li><a href="<?php echo e(URL::to('myorder')); ?>">Mes commandes</a></li>
                <li><a href="<?php echo e(URL::to('logout')); ?>">Deconnexion</a></li>                
              </ul>
            </li>
            ...
            <li><a href="<?php echo e(URL::to('register')); ?>">S'enregistrer</a></li>

            <?php endif; ?>

            <li><a href="<?php echo e(URL::to('about')); ?>">A propos de nous</a></li>
